...
```{r ans13}
sumgradeEcon <- sum(grade*fromEcon)
meanEcon <- sumgradeEcon/sumEcon
meanEcon
```
...
```{r ans31}
earnedgrade <- c(grade >=60)
ECcredit <- earnedgrade*credit
earnedcredit <- as.integer(ECcredit)
class(earnedcredit)
earnedcredit
```
...
```{r ans33}
earnedCredit100ChosenStudent <-sum(studentID == "046S6f645"
    &schoolYear == 100
    &earnedcredit)
...
```{r ans34}
ChosenGrade <- c(studentID == "046S6f645"
    &schoolYear == 100
    &earnedcredit>=0
    )
class(ChosenGrade)
sum(ChosenGrade*earnedcredit)
gpa100ChosenStudent <- sum(ChosenGrade*earnedcredit)/credit100ChosenStudent
gpa100ChosenStudent
```
